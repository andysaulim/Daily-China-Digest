...
def build_user_prompt(payload: dict, date_str: str, db_context: str = "") -> str:
    def tier_json(articles: list, max_items: int = 60) -> str:
        ...
        for a in trimmed:
            ...
            for optional in ("prestige_tier", "china_primary", "journal_tier",
                             "prestige_outlet", "flagged_journalist", "tags", "seen_before"):
                if a.get(optional):
